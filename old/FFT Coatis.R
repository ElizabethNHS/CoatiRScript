...
write.csv(data, "C:/Users/eliza/Documents/UNI/SS23/MPI-Bachelorarbeit/R_Thesis/Coaticsv/accdata2.csv")

# mydata <- read.csv("accdata2.csv")                #I am reading the accdata2 csv file into a data frame called mydata mithilfe von read.csv
rm(mydata)                     #removes mydata, dont forget to comment it out afterwards
